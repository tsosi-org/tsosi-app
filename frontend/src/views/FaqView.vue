    ...
    <template #default>
      ...
      <ul>
        <li>
          ...
          DOAJ, DOAB, PCI, SciPost, and OPERAS. This is already relevant,
          because it's the first time that one can explore these data, but keep
          in mind that it's only a small part of the funding landscape for open
          science.
        </li>
      ...
      <p>
        ...
        />
        to lead the project. The idea of the platform originated in 2020 within
        a research library: if everyone can see which organizations have
        financially supported an open infrastructure, then the decision to do
        the same would become much more evident.
      </p>
      ...
      <p>
        ...
        PeerCommunityIn, OPERAS, and Couperin are part of the governance of the
        project.
      </p>
      ...
      <h2 id="data-provider-infra">
        What are the infrastructures that provide the data?
      </h2>
      <p>
      ...
      <p>
        ...
        <RouterLink :to="'/pages/faq#contact-us'">Contact us</RouterLink>. You
        will need to provide (i) financial data structured in accordance with
        the
        <ExternalLinkAtom
          :label="'data collection schema'"
          :href="'https://github.com/tsosi-org/data-collection-schema'"
        />
        and (ii) the Memorandum of Understanding signed by both the
        infrastructure's legal entity and Université Grenoble Alpes.
        <br />
        <br />

        <b>Institutions and consortia</b>: TSOSI also strongly welcomes
        institutions and consortia to join the project. For the 2025-26 cycle,
        we plan to work with consortia to collect and ingest these new data. For
        research institutions, we plan to work with
        <ExternalLinkAtom
          :label="'openCost'"
          :href="'https://www.opencost.de/en/'"
        />, which allows institutions to notably practise open data for funding
        made in favor of open infrastructures:
        <RouterLink :to="'/pages/faq#contact-us'">drop us a line</RouterLink>
        to be part of this!
      </p>

      <h2 id="open-science-infrastructure-meaning">
        What do you mean by open science infrastructure?
      </h2>
      <p>
      ...
      <h2 id="tsosi-publications-infrastructure">
        Does TSOSI only concern infrastructures dedicated to publications?
      </h2>
      <p>
        No. For its launching year, TSOSI has worked with infrastructures more
        focused on publications, but all infrastructures, like the one dedicated
        to software, data, monitoring, or identifiers, are, of course, in the
        scope of TSOSI.
      </p>
      ...
      <h2 id="data-update-frequency">
        With which frequency is the data updated?
      </h2>
      <p>
        It depends on the infrastructure. The lowest frequency at which the data
        are updated is once a year; the maximum frequency is once a day. For
        example, the SciPost financial data are updated once a day thanks to its
        software, which includes an API, see the
        <ExternalLinkAtom
      ...
      <p>
        ...
        <CodeBlockAtom
          ...
          :inline="true"
          :background="true"
        />, which allows you to get the data. Moreover, we have an open API: see
        how to use with this
        <ExternalLinkAtom
          :label="'API use case'"
          :href="'https://github.com/tsosi-org/api-use-cases'"
        />
        repository. The data dump is pending. Please be patient; we still need
      ...
      <h2 id="why-dont-i-see-the-supports-made-by-my-organization">
        Why don't I see the supports made by my organization?
      </h2>
      <p>
        TSOSI is in beta version: for its launch, it includes only the financial
        support made by
      ...
      <h2 id="from-the-doaj-or-doab-page-why-can-i-not-see-my-institution">
        From the DOAJ or DOAB page, why can I not see my institution?
      </h2>
      <p>
        First, note that TSOSI has DOAJ and DOAB financial data starting in
        2021. It's indicated in TSOSI's platform in the middle of their webpage.
        Secondly, and only for the DOAJ, note that for 2021, TSOSI did not have
        the breakdown data, but only the intermediary one, like a library
        consortium. These two factors can explain why you don't see your
        institution's contribution.
      </p>

      <h2 id="what-does-the-date-column-refer-to">
        What does the date column refer to?
      </h2>
      <p>
      ...
      <h2 id="add-data-from-my-institution">
        How can I add the support made by my institution?
      </h2>
      <p>
        ...
        <ExternalLinkAtom
          ...
          :href="'https://www.opencost.de/en/'"
        />
        project. TSOSI will then collect your structured and enriched data. Feel
        free to
      ...
      <p>
        ...
        relationship between them is implemented. It is something that can be
        added using the
        <ExternalLinkAtom
      ...
      <p>
        Very good idea! You will need a Wikidata record of your organization and
        your logo file. Here is the process:
      </p>
      <ol>
        <li>
      ...
      <h2 id="add-wiki-description">
        How can I add a description of my organization?
      </h2>
      <p>
      ...
      <ol>
        <li>
          Enrich or create the Wikipedia entry of your organization in English.
        </li>
